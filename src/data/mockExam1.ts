        ...
        blanksPassage: [
          {
            ...
            options: [
              ["A 沟通有障碍", "B 干活不规范", "C 成为一名顶尖的软件工程师", "D 不善于说"不"，不懂得时间管理", "E 终于，他如愿以偿地进入了一家知名公司实习"]
            ],
            questions: [
          ...
          },
          {
            ...
            options: [
              ["A 神志也有些模糊", "B 脚上打着石膏", "C 嘴里不停地念叨着我的名字", "D 顿时昏迷不醒", "E 顿时刺中了我心中的最痛点"]
            ],
            questions: [
...
export const allMockExams: MockExam[] = [mockExam1];
